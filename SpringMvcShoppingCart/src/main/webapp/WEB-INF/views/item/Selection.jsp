...
<body>
	...
	<table cellpadding="2" cellspacing="2" border="1">
		...
		<c:forEach var="item" items="${sessionScope.item }">
			...
			<tr>
				<td align="center"><a
					href="${pageContext.request.contextPath }/item/remove/${item.product.productId }"
					onclick="return confirm('Are you sure?')">Remove</a></td>
				<td>${item.product.productId }</td>
				<td>${item.product.productName }</td>
				<td><img src="${pageContext.request.contextPath }/resources/static/images/${item.product.productPhoto }" width="50"></td>
